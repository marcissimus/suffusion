...
$sidebar_2_alignment = 'right';  // Default value
...
if (is_page_template('1l-sidebar.php') || 
    ...
    $sidebar_2_alignment = 'left';
         ...
         is_page_template('1l1r-sidebar.php') || 
...
?>
    <div class="dbx-group <?php echo esc_attr($sidebar_2_alignment . ' ' . $suf_wa_sb2_style); ?> warea" id="sidebar-2">
<?php
}
else {
?>
    <div class="tabbed-sidebar tab-box-<?php echo esc_attr($sidebar_2_alignment); ?> <?php echo esc_attr($sidebar_2_alignment); ?> warea fix" id="sidebar-2">
